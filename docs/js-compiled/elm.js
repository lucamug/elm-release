...
var $author$project$Main$Stable = function (a) {
	return {$: 'Stable', a: a};
};
var $author$project$Main$Unreleased = {$: 'Unreleased'};
var $author$project$Main$init = function (flags) {
	var initReleaseTransition = $author$project$Main$Stable($author$project$Main$Unreleased);
	return _Utils_Tuple2(
		{
			codeBuddy: '',
			codeOperator: '',
...
var $author$project$Main$Moving = F2(
	function (a, b) {
		return {$: 'Moving', a: a, b: b};
	});
var $author$project$Main$MsgEndMoving = {$: 'MsgEndMoving'};
...
var $author$project$Main$updateHelper = F3(
	function (model, newReleaseTransition, cmd) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					log: A2($elm$core$List$cons, newReleaseTransition, model.log),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MsgEndMoving':
				var _v1 = model.releaseTransition;
				if (_v1.$ === 'Moving') {
					var to = _v1.b;
					return A3(
						$author$project$Main$updateHelper,
						model,
						$author$project$Main$Stable(to),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'MsgConfirmRelease':
				var _v2 = model.releaseTransition;
				if (_v2.$ === 'Request') {
					var from = _v2.a;
					var to = _v2.b;
					return A3(
						$author$project$Main$updateHelper,
						model,
						A2($author$project$Main$Moving, from, to),
						A2(
							$elm$core$Task$perform,
							$elm$core$Basics$always($author$project$Main$MsgEndMoving),
							$elm$core$Process$sleep(1000)));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'MsgCancel':
				var _v3 = model.releaseTransition;
				switch (_v3.$) {
					case 'Request':
						var from = _v3.a;
						return A3(
							$author$project$Main$updateHelper,
							model,
							$author$project$Main$Stable(from),
							$elm$core$Platform$Cmd$none);
					case 'Moving':
						var from = _v3.a;
						return A3(
			...
			default:
				var to = msg.a;
				var _v4 = model.releaseTransition;
				if (_v4.$ === 'Stable') {
					var from = _v4.a;
					return A3(
						$author$project$Main$updateHelper,
						model,
						A2($author$project$Main$Request, from, to),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Main$viewEmptyOverlay = $mdgriffith$elm_ui$Element$inFront(
	A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'pointer-events', 'none')),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$style, 'transition', 'all 500ms'))
			]),
		$mdgriffith$elm_ui$Element$none));
var $author$project$Main$MsgCancel = {$: 'MsgCancel'};
var $mdgriffith$elm_ui$Internal$Model$AlignY = function (a) {
	return {$: 'AlignY', a: a};
};
var $mdgriffith$elm_ui$Internal$Model$Bottom = {$: 'Bottom'};
var $mdgriffith$elm_ui$Element$alignBottom = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$Bottom);
var $author$project$Main$alphaLayer = 0.7;
...
var $author$project$Main$shadow = {
	blur: 0,
	color: A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.2),
	offset: _Utils_Tuple2(2, 5),
	size: 2
};
...
var $author$project$Main$buttonAttrs = _List_fromArray(
	[
		...
		$mdgriffith$elm_ui$Element$Border$shadow($author$project$Main$shadow),
		$mdgriffith$elm_ui$Element$Background$color(
...
var $author$project$Main$viewMoving = F2(
	function (from, to) {
		return $mdgriffith$elm_ui$Element$inFront(
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color(
						A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, $author$project$Main$alphaLayer)),
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'transition', 'all 500ms'))
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$html(
									A2(
										...
										A2(
											...
											A2($elm$core$List$repeat, 12, _Utils_Tuple0))))),
								A2(
								...
								$author$project$Main$buttonAttrs,
								{
									...
									onPress: $elm$core$Maybe$Just($author$project$Main$MsgCancel)
								})
							])))));
	});
var $author$project$Chart$listNumber = _List_fromArray(
	[46, 48, 42, 38, 34, 38, 43, 45, 34, 36, 37, 32, 46, 43, 49, 48]);
var $author$project$Chart$actual1 = A2(
	$elm$core$List$indexedMap,
	F2(
		function (index, y) {
			return {x: index, y: y};
		}),
	A2($elm$core$List$cons, 0, $author$project$Chart$listNumber));
...
var $author$project$Chart$chartConfig = function (yAxis) {
	return {
		...
		dots: $terezka$line_charts$LineChart$Dots$custom(
			$terezka$line_charts$LineChart$Dots$full(4)),
...
var $author$project$Chart$chart = F3(
	function (data1, data2, yAxis) {
		return A2(
			$terezka$line_charts$LineChart$viewCustom,
			$author$project$Chart$chartConfig(yAxis),
			_List_fromArray(
				[
					A4($terezka$line_charts$LineChart$line, $terezka$line_charts$LineChart$Colors$purple, $terezka$line_charts$LineChart$Dots$circle, 'Actual', data1),
					A4($terezka$line_charts$LineChart$line, $terezka$line_charts$LineChart$Colors$blue, $terezka$line_charts$LineChart$Dots$square, 'Expected', data2)
				]));
	});
var $author$project$Chart$expected1 = A2(
	$elm$core$List$indexedMap,
	F2(
		function (index, y) {
	...
	_Utils_ap(
		$elm$core$List$reverse($author$project$Chart$listNumber),
		$author$project$Chart$listNumber));
var $author$project$Chart$chart1 = A3($author$project$Chart$chart, $author$project$Chart$actual1, $author$project$Chart$expected1, 'CVR');
var $author$project$Chart$actual2 = A2(
	$elm$core$List$indexedMap,
	F2(
		function (index, y) {
			return {x: index, y: y * 3};
		}),
	A2(
		$elm$core$List$cons,
		0,
		$elm$core$List$reverse($author$project$Chart$listNumber)));
var $author$project$Chart$expected2 = A2(
	$elm$core$List$indexedMap,
	F2(
		function (index, y) {
			return {x: index + 1, y: y};
	...
	_Utils_ap(
		$author$project$Chart$listNumber,
		$elm$core$List$reverse($author$project$Chart$listNumber)));
var $author$project$Chart$chart2 = A3($author$project$Chart$chart, $author$project$Chart$actual2, $author$project$Chart$expected2, 'Errors');
...
var $author$project$Main$viewFooter = A2(
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('This is a proof of concept so it has not effects whatsoever')
		]));
var $author$project$Main$buddy = 'Cindy';
...
var $author$project$Main$operator = 'Jason';
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			_List_Nil,
			{
				label: $mdgriffith$elm_ui$Element$text('ELM-2968'),
				url: 'https://jira.com/jira/browse/ELM-2968'
			}),
			$mdgriffith$elm_ui$Element$text(' ◆ Tuesday March 17, 2022 ◆ '),
			$mdgriffith$elm_ui$Element$text('Operator '),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text($author$project$Main$operator)),
			$mdgriffith$elm_ui$Element$text(' ◆ Buddy '),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text($author$project$Main$buddy)),
			...
			_List_Nil,
			{
				label: $mdgriffith$elm_ui$Element$text('Zoom'),
			...
			$mdgriffith$elm_ui$Element$text('UI ')),
			$mdgriffith$elm_ui$Element$text('8f1d77814f0-527 '),
			A2(
			$mdgriffith$elm_ui$Element$newTabLink,
			_List_Nil,
			{
				label: $mdgriffith$elm_ui$Element$text('1.7.0'),
			...
			_List_Nil,
			{
				label: $mdgriffith$elm_ui$Element$text('1.6.0'),
			...
			$mdgriffith$elm_ui$Element$text('77d02609c83-882 '),
			A2(
			$mdgriffith$elm_ui$Element$newTabLink,
			_List_Nil,
			{
				label: $mdgriffith$elm_ui$Element$text('1.7.1'),
...
var $author$project$Main$releaseStateToString = function (releaseState) {
	switch (releaseState.$) {
		case 'Unreleased':
			return 'Not Released';
		case 'Released000':
...
var $author$project$Main$releaseTransitionToString = function (releaseTransition) {
	switch (releaseTransition.$) {
		case 'Stable':
			var from = releaseTransition.a;
			return 'State: \"' + ($author$project$Main$releaseStateToString(from) + '\"');
		case 'Request':
			var from = releaseTransition.a;
			var to = releaseTransition.b;
			return 'Requested to change from \"' + ($author$project$Main$releaseStateToString(from) + ('\" to \"' + ($author$project$Main$releaseStateToString(to) + '\"')));
		default:
			var from = releaseTransition.a;
			var to = releaseTransition.b;
			return 'Changed from \"' + ($author$project$Main$releaseStateToString(from) + ('\" to \"' + ($author$project$Main$releaseStateToString(to) + '\"')));
	}
};
					...
					F2(
						function (index, log) {
							return A2(
								...
								_List_Nil,
								$mdgriffith$elm_ui$Element$text(
									$elm$core$String$fromInt(index + 1) + (' - ' + $author$project$Main$releaseTransitionToString(log))));
						}),
					$elm$core$List$reverse(model.log)))
			]));
};
...
var $author$project$Main$variation = F3(
	function (rangeA, rangeB, ratio) {
		return (_Utils_cmp(rangeA, rangeB) < 0) ? $elm$core$Basics$round(rangeA + (ratio * (rangeB - rangeA))) : $elm$core$Basics$round(rangeA - (ratio * (rangeA - rangeB)));
	});
var $author$project$Main$color = F2(
	function (ratio, alpha) {
		return A4(
			$mdgriffith$elm_ui$Element$rgba255,
			A3($author$project$Main$variation, 3, 156, ratio),
			A3($author$project$Main$variation, 169, 39, ratio),
			A3($author$project$Main$variation, 244, 176, ratio),
			alpha);
	});
var $author$project$Main$Released000 = {$: 'Released000'};
var $author$project$Main$Released001 = {$: 'Released001'};
var $author$project$Main$Released005 = {$: 'Released005'};
var $author$project$Main$Released010 = {$: 'Released010'};
var $author$project$Main$Released100 = {$: 'Released100'};
var $author$project$Main$releaseStateList = _List_fromArray(
	[$author$project$Main$Unreleased, $author$project$Main$Released000, $author$project$Main$Released001, $author$project$Main$Released005, $author$project$Main$Released010, $author$project$Main$Released100]);
var $author$project$Main$getIndex = function (releaseStateToFind) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (releaseState, _v0) {
				var found = _v0.a;
				var index = _v0.b;
				return found ? _Utils_Tuple2(found, index) : (_Utils_eq(releaseStateToFind, releaseState) ? _Utils_Tuple2(true, index) : _Utils_Tuple2(false, index + 1));
			}),
		_Utils_Tuple2(false, 0),
		$author$project$Main$releaseStateList).b;
};
var $author$project$Main$listLength = $elm$core$List$length($author$project$Main$releaseStateList);
var $author$project$Main$val1 = $author$project$Main$listLength / ($author$project$Main$listLength - 1);
var $author$project$Main$indexToRatio = function (index) {
	return (index * $author$project$Main$val1) / $author$project$Main$listLength;
};
var $author$project$Main$releaseName = '[Elm] Version 1.7.1';
var $author$project$Main$viewState = F2(
	function (_v0, releaseState) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Background$color(
						A2(
							$author$project$Main$color,
							$author$project$Main$indexToRatio(
								$author$project$Main$getIndex(releaseState)),
							1)),
						$mdgriffith$elm_ui$Element$Font$color(
						...
						$mdgriffith$elm_ui$Element$Font$center,
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'transition', 'all 1000ms'))
					]),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(
						$author$project$Main$releaseName + (': ' + $author$project$Main$releaseStateToString(releaseState)))
					])));
	});
var $mdgriffith$elm_ui$Internal$Model$Top = {$: 'Top'};
var $mdgriffith$elm_ui$Element$alignTop = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$Top);
var $author$project$Main$MsgOnSwitch = function (a) {
	return {$: 'MsgOnSwitch', a: a};
};
...
var $author$project$Main$releaseStateToStringShort = function (releaseState) {
	switch (releaseState.$) {
		case 'Unreleased':
			return 'NR';
		case 'Released000':
...
var $author$project$Main$bigButton = F2(
	function (args, releaseState) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_Utils_ap(
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Background$color(
						A2($author$project$Main$color, args.ratio, 1)),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'transition', 'all 300ms')),
						...
						A2(
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$htmlAttribute(
										A2($elm$html$Html$Attributes$style, 'transition', 'all 300ms')),
										$mdgriffith$elm_ui$Element$Border$rounded(80),
										$mdgriffith$elm_ui$Element$Background$color(
							...
							A2(
								...
								$mdgriffith$elm_ui$Element$text(
									$author$project$Main$releaseStateToStringShort(releaseState)))))
					]),
				args.activable ? _List_fromArray(
					[
					...
					]) : _List_Nil)),
			{
				...
				onPress: (args.activable || args.active) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
					$author$project$Main$MsgOnSwitch(releaseState))
			});
	});
var $author$project$Main$isBefore = F2(
	function (releaseState1, releaseState2) {
		return _Utils_cmp(
			$author$project$Main$getIndex(releaseState1) + 1,
			$author$project$Main$getIndex(releaseState2)) < 0;
	});
...
var $author$project$Main$releaseStateTime = function (releaseState) {
	switch (releaseState.$) {
		case 'Unreleased':
			return '';
		case 'Released000':
...
var $author$project$Main$viewSwitches = F2(
	function (releaseState, attemptedReleaseState) {
		return A2(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									{
										activable: A2($author$project$Main$isBefore, releaseState, releaseState_),
										active: _Utils_eq(releaseState_, releaseState),
										attempted: function () {
											if (attemptedReleaseState.$ === 'Just') {
												var attempted = attemptedReleaseState.a;
												return _Utils_eq(attempted, releaseState_);
											} else {
												return false;
											}
										}(),
										ratio: $author$project$Main$indexToRatio(index)
									},
									releaseState_),
									A2(
									$mdgriffith$elm_ui$Element$el,
									...
									$mdgriffith$elm_ui$Element$text(
										$author$project$Main$releaseStateTime(releaseState_)))
								]));
					}),
				$author$project$Main$releaseStateList));
	});
var $author$project$Main$viewReleaseState = F4(
	function (model, releaseState, attemptedReleaseState, layerInFront) {
		return A3(
				...
				options: _List_fromArray(
					[
						$mdgriffith$elm_ui$Element$focusStyle(
						{
							backgroundColor: $elm$core$Maybe$Nothing,
							borderColor: $elm$core$Maybe$Nothing,
							shadow: $elm$core$Maybe$Just($author$project$Main$shadow)
						})
					])
			},
			_Utils_ap(
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$inFront(
							A2($author$project$Main$viewState, model.width, releaseState))
						]))),
			A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Main$viewSwitches, releaseState, attemptedReleaseState),
								A2(
								$mdgriffith$elm_ui$Element$wrappedRow,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$html($author$project$Chart$chart1)),
										A2(
										$mdgriffith$elm_ui$Element$el,
										_List_fromArray(
											[
										...
										$mdgriffith$elm_ui$Element$html($author$project$Chart$chart2))
									])),
								$author$project$Main$viewLog(model),
								$author$project$Main$viewFooter
							]))
					])));
	});
var $author$project$Main$MsgConfirmRelease = {$: 'MsgConfirmRelease'};
var $author$project$Main$viewRequest = F2(
	function (from, to) {
		return $mdgriffith$elm_ui$Element$inFront(
			A2(
				$mdgriffith$elm_ui$Element$el,
									...
									_List_fromArray(
										[
											...
											A2(
												$author$project$Main$color,
												$author$project$Main$indexToRatio(
													$author$project$Main$getIndex(to)),
												1)),
											$mdgriffith$elm_ui$Element$Font$color(
											A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1))
										])),
											...
											[
												...
												_List_fromArray(
													[
														...
														$mdgriffith$elm_ui$Element$text('Change from ')),
														$mdgriffith$elm_ui$Element$text(
														$author$project$Main$releaseStateToString(from))
													])),
												A2(
												$mdgriffith$elm_ui$Element$paragraph,
												_List_Nil,
												_List_fromArray(
													[
														...
														$mdgriffith$elm_ui$Element$text(
														$author$project$Main$releaseStateToString(to))
													]))
											])),
									onPress: $elm$core$Maybe$Just($author$project$Main$MsgConfirmRelease)
								}),
								A2(
								$mdgriffith$elm_ui$Element$Input$button,
								$author$project$Main$buttonAttrs,
...
var $author$project$Main$view = function (model) {
	var _v0 = model.releaseTransition;
	switch (_v0.$) {
		case 'Stable':
			var from = _v0.a;
			return A4(
				$author$project$Main$viewReleaseState,
				model,
				from,
				$elm$core$Maybe$Nothing,
				_List_fromArray(
					[$author$project$Main$viewEmptyOverlay]));
		case 'Request':
			var from = _v0.a;
			var to = _v0.b;
			return A4(
				...
				_List_fromArray(
					[
						A2($author$project$Main$viewRequest, from, to)
					]));
		default:
			var from = _v0.a;
			var to = _v0.b;
			return A4(
				...
				_List_fromArray(
					[
						A2($author$project$Main$viewMoving, from, to)
					]));
	}
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"MsgCodeOperator":["String.String"],"MsgCodeBuddy":["String.String"],"MsgConfirmRelease":[],"MsgCancel":[],"MsgOnSwitch":["Main.ReleaseState"],"MsgEndMoving":[]}},"Main.ReleaseState":{"args":[],"tags":{"Unreleased":[],"Released000":[],"Released001":[],"Released005":[],"Released010":[],"Released100":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));